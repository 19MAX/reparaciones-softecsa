...
<div class="page-header">
    <ul class="breadcrumbs ps-1 ms-0">
        <li class="nav-home">
            <a href="<?= base_url('recepcionista/dashboard') ?>"><i class="icon-home"></i></a>
        </li>
        <li class="separator"><i class="icon-arrow-right"></i></li>
        <li class="nav-item"><a href="<?= base_url('recepcionista/ordenes') ?>">Órdenes</a></li>
        <li class="separator"><i class="icon-arrow-right"></i></li>
            ...
            <div class="card-body">
                ...
                <ul class="list-group list-group-flush mb-3">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                        ...
                        <a href="<?= base_url('recepcionista/ordenes/editar/' . $dispositivo['orden_id']) ?>">
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width:420px;">
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-footer border-0 pt-0">
                <a href="<?= base_url('recepcionista/clientes/ver/' . ($dispositivo['cliente_id'] ?? '')) ?>"
