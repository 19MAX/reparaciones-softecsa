...
<div class="page-header">
    <ul class="breadcrumbs ps-1 ms-0">
        ...
        <li class="nav-item"><a href="#">Mis Dispositivos Asignados</a></li>
    </ul>
</div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body py-3">
                <div class="d-flex align-items-center gap-3 flex-wrap">
                    ...
                    <!-- Total comisiones -->
                    <div class="stat-pill">
                        <div class="stat-pill-label">Mis Comisiones</div>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center py-5 text-muted">
                    <p class="mb-0">No tienes dispositivos asignados.</p>
                </div>
            </div>
        </div>
    <?php endif; ?>
            ...
            <div class="dev-card <?= $vencido ? 'dev-card--vencida' : '' ?>">
                ...
                <div class="dev-card__body">
                    ...
                    <div class="dev-card__row-top">
                        <span class="dev-card__orden-link">
                ...
                <div class="dev-card__footer">
                    ...
                    <a href="<?= base_url('tecnico/dispositivos/detalle/' . $dev['id']) ?>" class="dev-card__btn-ver">Ver / Actualizar</a>
                </div>
