    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body pb-0">
                <div class="d-flex">
                    <div class="avatar">
                        <img src="<?= base_url('assets') ?>/img/logoproduct.svg" alt="..."
                ...
                <div class="d-flex">
                    <div class="avatar">
                        <img src="<?= base_url('assets') ?>/img/logoproduct3.svg" alt="..."
                            class="avatar-img rounded-circle">
                    </div>
                    <div class="flex-1 pt-1 ms-2">
                        <h6 class="fw-bold mb-1">Ready Pro</h6>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="d-flex">
                    ...
                    <div class="flex-1 ms-3 pt-1">
                        <h6 class="text-uppercase fw-bold mb-1">Peter Parker <span class="text-success ps-3">open</span>
                        </h6>
                        <span class="text-muted">I have some query regarding the license
                            issue.</span>
                    </div>
                ...
                <div class="d-flex">
                    ...
                    <div class="flex-1 ms-3 pt-1">
                        <h6 class="text-uppercase fw-bold mb-1">Logan Paul <span class="text-muted ps-3">closed</span>
                        </h6>
                        <span class="text-muted">Is there any update plan for RTL version near
                            future?</span>
                    </div>
