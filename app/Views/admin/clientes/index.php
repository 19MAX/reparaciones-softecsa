                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            <!-- Botón Ver Perfil -->
                                            <a href="<?= base_url('admin/clientes/ver/' . $cli['id']) ?>"
...
<div class="modal fade" id="modalCrearCliente" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/clientes/crear') ?>" method="POST">
                <?= csrf_field() ?>
...
<div class="modal fade" id="modalEditarCliente" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/clientes/editar') ?>" method="POST">
                <?= csrf_field() ?>
...
<div class="modal fade" id="modalEliminarCliente" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/clientes/eliminar') ?>" method="POST">
                <?= csrf_field() ?>
