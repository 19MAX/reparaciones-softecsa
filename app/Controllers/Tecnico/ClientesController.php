...
class ClientesController extends BaseController
{
    ...
    {
        $rules = [
            'cedula' => 'required|is_unique[clientes.cedula]|max_length[20]',
            'nombres' => 'required|max_length[100]',
            'apellidos' => 'required|max_length[100]',
            'email' => 'permit_empty|valid_email|max_length[150]',
            'telefono' => 'permit_empty|max_length[20]',
        ...
        $data = [
            ...
            'telefono_secundario' => $this->request->getPost('telefono_secundario'),
    ...
    public function editar()
    {
        ...
        $rules = [
            'cedula' => "required|max_length[20]|is_unique[clientes.cedula,id,{$id}]",
            'nombres' => 'required|max_length[100]',
            'apellidos' => 'required|max_length[100]',
            'email' => 'permit_empty|valid_email|max_length[150]',
            'telefono' => 'permit_empty|max_length[20]',
